            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Registra las medidas corporales del cliente
                  </DialogDescription>
                </DialogHeader>
                <MedicionForm 
          ...
          {clientes.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 text-lg">
                Primero debes agregar clientes para registrar mediciones.
              </p>
            </div>
          ) : mediciones.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 text-lg">
                No hay mediciones registradas. Registra la primera medición.
              </p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {mediciones.slice().reverse().map((medicion) => {
                      ...
                      <TableRow key={medicion.id} className="hover:bg-gray-50 transition-colors">
                        <TableCell>
                          <div className="font-semibold text-gray-900">
                            {getClienteNombre(medicion.clienteId)}
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <span className={`font-bold text-lg ${getIMCColor(imc)}`}>
                            {imc}
                          </span>
                        </TableCell>
      ...
      <Dialog open={detailDialogOpen} onOpenChange={setDetailDialogOpen}>
        <DialogContent className="max-w-2xl rounded-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Mediciones completas del cliente
            </DialogDescription>
          </DialogHeader>
          {selectedMedicion && (
            <MedicionDetail 
              medicion={selectedMedicion}
              clienteNombre={getClienteNombre(selectedMedicion.clienteId)}
            />
          )}
        </DialogContent>
      </Dialog>
